...
**Goal:** Prove the 496-test suite passes on actual Pi hardware before touching crons.
...
- Do NOT proceed to Phase 3 until all 496 pass
...
| Command | Purpose |
|---------|---------|
| `npm run dl:test` | Run all 496 tests |
