...
**Goal:** Prove the 502-test suite passes on actual Pi hardware before touching crons.
...
- Do NOT proceed to Phase 3 until all 502 pass
...
| Command | Purpose |
|---------|---------|
| `npm run dl:test` | Run all 502 tests |
