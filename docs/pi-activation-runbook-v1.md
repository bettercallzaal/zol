...
**Goal:** Prove the 518-test suite passes on actual Pi hardware before touching crons.
...
- Do NOT proceed to Phase 3 until all 518 pass
...
| Command | Purpose |
|---------|---------|
| `npm run dl:test` | Run all 518 tests |
