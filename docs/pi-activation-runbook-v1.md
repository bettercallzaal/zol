...
**Goal:** Prove the 528-test suite passes on actual Pi hardware before touching crons.
...
- Do NOT proceed to Phase 3 until all 528 pass
...
| Command | Purpose |
|---------|---------|
| `npm run dl:test` | Run all 528 tests |
