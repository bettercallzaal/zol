...
**Goal:** Prove the 492-test suite passes on actual Pi hardware before touching crons.
...
- Do NOT proceed to Phase 3 until all 492 pass
...
| Command | Purpose |
|---------|---------|
| `npm run dl:test` | Run all 492 tests |
