...
**Goal:** Prove the 508-test suite passes on actual Pi hardware before touching crons.
...
- Do NOT proceed to Phase 3 until all 508 pass
...
| Command | Purpose |
|---------|---------|
| `npm run dl:test` | Run all 508 tests |
