...
**Goal:** Prove the 532-test suite passes on actual Pi hardware before touching crons.
...
- Do NOT proceed to Phase 3 until all 532 pass
...
| Command | Purpose |
|---------|---------|
| `npm run dl:test` | Run all 532 tests |
